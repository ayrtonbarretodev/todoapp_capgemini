...
public class MainScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanelTasksLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelTasksLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jLabelTasksTitle, javax.swing.GroupLayout.PREFERRED_SIZE, 290, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanelEmptyListLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelEmptyListLayout.createSequentialGroup()
                .addGroup(jPanelEmptyListLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabelEmptyListSubTitle, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 456, Short.MAX_VALUE)
    ...
    private void showJTableTasks(boolean hasTaks) {

        //Caso tenha tarefas
        if (hasTaks) { //verifica se existem tarefas
            if (jPanelEmptyList.isVisible()) { //verifica se a lista vazia está visível para o usuário, caso seja verdade:
                jPanelEmptyList.setVisible(false); //deixa ela invisivel 
                jPanel5.remove(jPanelEmptyList); //e remove
            }

            //Já que tem tarefas, coloca o jPane5 dentro do jScrollPaneTasksd, torna ele visível p/ o usuario
            jPanel5.add(jScrollPaneTasks);
            jScrollPaneTasks.setVisible(true);
            jScrollPaneTasks.setSize(jPanel5.getWidth(), jPanel5.getHeight());

        } else { //Caso NÃO tenha tarefas - é o processo contrário
